...
import avatar from '../../../../atoms/Avatars/TeamAvatar/2902136784_1715631956.jpg.png';
    ...
    return (
        <div className='flex border-2 w-72 border-blue gap-3 rounded-xl'>
            ...
            <div className='grid items-center'>
                <LeftSlideText text='Юлия Кожурина'/>
                <p className='-mt-4 text-xs'>В команде с 13.05.2024</p>
            </div>
        </div>
    );
};
