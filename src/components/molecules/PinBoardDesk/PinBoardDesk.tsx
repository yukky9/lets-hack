...
const PinBoardDesk = () => {
    return (
        ...
        <form>
            <div
                className="mt-5 w-full mb-4 border border-blue rounded-lg bg-white-blue dark:bg-w dark:border-blue">
                ...
                <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-white">
                    <label htmlFor="editor" className="sr-only">Publish post</label>
                    <textarea id="editor"
                              className="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-white focus:ring-0 dark:text-black dark:placeholder-gray-400"
